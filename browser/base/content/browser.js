  ...
  onCertError(browser, elementId, isTopFrame, location, securityInfoAsString) {
    ...
    switch (elementId) {
      case "exceptionDialogButton":
        ...
        var SSL_ERR_MSG="Couldn't get ssl_override pref: "
        ...
        try {
          ...
          Components.utils.reportError( SSL_ERR_MSG + e);
        }
...
function getDefaultHomePage() {
  ...
  var HOMEPAGE_PREF_ERR="Couldn't get homepage pref: "
  try {
    ...
    Components.utils.reportError(HOMEPAGE_PREF_ERR + e);
  }
  return url;
}
...
var gIdentityHandler = {
  ...
  removeCertException() {
    ...
    if (!this._uriHasHost) {
      var CERT_ERR="Trying to revoke a cert exception on a URI without a host?"
      Cu.reportError(CERT_ERR);
      return;
    }
